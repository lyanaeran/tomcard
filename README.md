...
**POC de combat** jouable (pas de boucle de run complète) — voir `poc.md` pour le détail du POC et
`specs.md` pour la vision de conception globale du jeu complet.
...
C'est la version de référence : la plus fidèle à `poc.md`/`specs.md`.
...
Cette version a quelques simplifications visuelles assumées par rapport à `poc.md` (détaillées dans
